...
if(cv=="i1"){
  ...
  if(cv=="s1"){
    document.getElementById(`body`).style.background = ("url('assets/img/beach.png')")
    document.getElementById(`body`).style.backgroundSize = ("100%")
    ui("black")
  }
  if(cv=="s2"){
    document.getElementById(`body`).style.background = ("url('assets/img/forest.png')")
    document.getElementById(`body`).style.backgroundSize = ("100%")
    ui("black")
  }
  if(cv=="s3"){
    document.getElementById(`body`).style.background = ("url('assets/img/mountain.png')")
    document.getElementById(`body`).style.backgroundSize = ("100%")
    ui("black")
  }
